...
//    }
    ...
    @PutMapping("/normal/updateUser/{id}")
    @ResponseBody
    public Map<String, String> updateUser(@PathVariable int id, @RequestBody Map<String, String> payload) {
        String sql = "UPDATE normal SET username = ?, emailid = ?, password = ? WHERE id = ?";
    ...
    @DeleteMapping("/normal/deleteUser/{id}")
    @ResponseBody
